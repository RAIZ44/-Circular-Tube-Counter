...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", default="data/audit_v2")
...
def main() -> None:
    ...
    if (output_dir / "manual_label_audit.csv").exists():
        raise FileExistsError("This audit directory already contains review data. Choose a new --output-dir to preserve it.")
